<footer>
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						...
						<img src="assets/img/logo/logo-beg.gif" class="logo" alt="Repute">
						<p>@lang('website.base_line_beg')</p>
						<br>
						<address class="margin-bottom-30px">
							<ul class="list-unstyled">
								<li>{!! setting('site.address_compagny') !!}
									<br/> {!! setting('site.zip_city') !!}</li>
								<li>Phone: (1800) 765 - 4321</li>
								<li>Email: {!! setting('site.email_contact') !!}</li>
							</ul>
						</address>
						<!-- END COLUMN 1 -->
					</div>
			...
			<div class="text-center copyright">
				&copy;2018 Anacode. All Rights Reserved.{{ session('language')}} {{ App::getLocale() }}
			</div>
			<!-- END COPYRIGHT -->
		</footer>
