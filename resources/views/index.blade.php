	...
	<div class="wrapper">
			...
			<div id="carousel-hero" class="slick-carousel">
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img src="assets/img/sliders/slider-beg2.png" class="img-responsive" alt="Slider Image">
						<div class="carousel-caption">
							<h2 class="hero-heading">CHARNIERES DE FENETRES</h2>
					...
					<div class="item">
						<img src="assets/img/sliders/slider-beg1.png" class="img-responsive" alt="Slider Image">
						<div class="carousel-caption">
							<h2 class="hero-heading">PORTES VITREES</h2>
							<p class="lead">Leave it to the theme, it knows how to deal with screen sizes</p>
							<a href="#" class="btn btn-lg hero-button">LEARN MORE</a>
						</div>
					</div>
					<div class="item">
						<img src="assets/img/sliders/slider-beg3.png" class="img-responsive" alt="Slider Image">
						<div class="carousel-caption">
		...
		<section class="recent-works">
			<div class="container">
				...
				<a href="#" class="btn btn-primary pull-right">see-all-news all works</a>
		...
		<section class="call-to-action">
			<div class="container">
				...
				<div class="pull-right">
					<span>Call us at (1800) 765 - 4321 or</span>&nbsp;&nbsp;<a href="#" class="btn btn-lg btn-primary">@lang('website.contact_us')</a>
				</div>
			</div>
		</section>
		<!-- END CALL-TO-ACTION -->
